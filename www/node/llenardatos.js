...
function cargarData(){
    ...
    async.series(
    	[
         ...
         comedorInsertar.menu.push({fecha:"31/07/2015",desayuno:"Pan con leche",almuerzo:"Comida Desconocida"});
         comedorInsertar.menu.push({fecha:"31/07/2015",desayuno:"Pan sin leche",almuerzo:"Comida Conocida"});
         comedorInsertar.menu.push({fecha:"31/07/2015",desayuno:"Noy hay desayuno",almuerzo:"Chaufa"});
    	 ...
    	 comedorInsertar.estudiantes.push({nombre:"EtsunNutricionista",apellidos:"Ortiz Guillen",codigo:"1003720122",carrera:"Ingenieria de sistemas",contrasena:"etsun"});
    	 comedorInsertar.estudiantes[0].consumo.push({servicio:"desayuno",fecha:"2015-07-08"});
    	 ...
    	 comedorInsertar.estudiantes.push({nombre:"KevinNutricionista",apellidos:"Ortiz Guillen",codigo:"1002620122",carrera:"Ingenieria de sistemas",contrasena:"kevin"});
    	 comedorInsertar.estudiantes[1].consumo.push({servicio:"desayuno",fecha:"2015-07-08"});
         //insertar nuevo 
